def main():
    ...
    # Convert the birth_day variable into an integer, and store the result in the variable birth_day_number
    birth_day_number = int(birth_day)

    # TO-DO: STORE THE VALUE OF birth_day_number IN THE VARIABLE running_number
